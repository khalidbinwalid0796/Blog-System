...
//            resize image for category and upload
            ...
            $category = Image::make($image)->resize(1600, 479, function ($constraint) {
            ...
            $slider = Image::make($image)->resize(500, 333, function ($constraint) {
                $constraint->aspectRatio();
            })->encode('jpg');
...
//            resize image for category and upload
            ...
            $categoryimage = Image::make($image)->resize(1600, 479, function ($constraint) {
                $constraint->aspectRatio();
            })->encode('jpg');
